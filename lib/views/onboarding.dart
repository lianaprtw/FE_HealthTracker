...
class _OnboardingViewState extends State<OnboardingView> {
  final PageController pageController = PageController(); // Controller untuk navigasi page (jika multi-page)
  int currentPage = 0; // Menyimpan indeks halaman saat ini

  @override
  Widget build(BuildContext context) {
    return Scaffold( // Struktur dasar tampilan
      body: Column( // Menyusun elemen secara vertikal
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 32), // Padding tombol
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween, // Menyusun tombol sejajar dan terpisah
              children: [
                Expanded( // Tombol Login mengisi setengah layar
                  child: GestureDetector(
                    ...
                    child: Container(
                      padding: EdgeInsets.symmetric(vertical: 13.5), // Tinggi tombol
                      decoration: BoxDecoration(
                        color: blueColor, // Warna background tombol
                        borderRadius: BorderRadius.circular(4), // Sudut tombol melengkung
                      ),
                      child: Text(
                        "Login", // Teks tombol
                        textAlign: TextAlign.center,
                ...
                Expanded( // Tombol Register mengisi setengah layar
                  child: GestureDetector(
                    onTap: () {
